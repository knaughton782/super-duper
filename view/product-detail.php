...
<main id="page-content">
    ...
    <section class="reviews">
        ...
        <form action="/acme/reviews/" method="post">
            <fieldset>
                ...
                <span
                    class="title"><?php echo $username = substr($_SESSION['clientData']['clientFirstname'], 0, 1) . $_SESSION['clientData']['clientLastname']; ?></span>
                <br><br>

                <label for="reviewText">Write review here:</label><br>
                <textarea name="reviewText" id="reviewText"
                    required><?php if (isset($reviewText)) {echo $reviewText; } ?></textarea>
    ...
    <section>
        ...
        <a href="/acme/index.php?action=login" title="Click to login to review a product" id="registrationLink">Please
            log in</a>
